...
# OUR CODE GOES BELOW
# 
months_of_the_years <- list(c("January","February","March","April","May","June","July","August","September","October","November","December"))
names(months_of_the_years) <- c("Months") 
...
```
R Basics (Lists and Vectors).md
Displaying R Basics (Lists and Vectors).md.